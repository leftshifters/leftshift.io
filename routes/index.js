    ...
    res.render('index',
        {
            ...
            description: 'Leftshift helps clients create loveable mobile applications for iOS, Android and the web',
            clients: clients.get(),
            projects: projects,
            team: team
        }
...
exports.post = function(req, res) {
    ...
    if( !_.isEmpty(post) ) {
        fs.readFile(__dirname + '/../posts/' + post.file, 'utf8', function(err, data) {
...
exports.love = function(req, res){
    res.render('love',
        {
            title: 'What has love got to do with making apps? | LeftShift | we create loveable apps for ios, android and the web',
            description: 'There is only one way to make amazing software. Love is what turns a good app into a piece of art.'
        }
    );
};
